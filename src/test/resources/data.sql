...
VALUES (1, 'Admin User', 'admin', '$2a$12$O9CpoX8MQ.N5EYG3jp3rwuZwtZNWHKmgovekvj/btz1KkqTDCWmF6', 'ROLE_ADMIN');

INSERT INTO users (id, name, username, password, role)
VALUES (2, 'Regular User', 'user', '$2a$12$rq2Nqnls1QOtlE3dHIir9Ohsgw0i/rofquxoTrQn3ttM.ig1GgZ72', 'ROLE_USER');
